									...
									<form action="myInfoUpdate" method="post" onsubmit="return validate();">
										...
										<div class="box">
											<div class="form-group mb-3" style="display:none">
												...
												<input type="text" class="form-control" id="grade" name="grade" value="${userVO.grade}" readonly="readonly"/>
											</div>
											
											<div class="form-group mb-3">
												<label for="state">학적상태</label>
												<input type="text" class="form-control" id="state" name="state" value="${userVO.state}" readonly="readonly"/>
											</div>
										</div>
