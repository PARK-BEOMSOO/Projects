...
<head>
<meta charset="utf-8" />
<title>HMIS :: MIS-DAY 출결 수정</title>
								...
								<div class="page-title-box">
									<div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="/admin/mis/list">MIS-DAY 출결 관리</a></li>
                                            <li class="breadcrumb-item active">MIS-DAY 출결 수정</li>
                                        </ol>
                                    </div>
									<h3 class="page-title">MIS-DAY 출결 수정</h3>
								</div>
							</div>
						</div>
