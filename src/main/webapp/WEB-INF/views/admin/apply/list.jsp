							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">자격증 신청 현황</li>
									</ol>
								</div>
								<h4 class="page-title">자격증 신청 현황</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
											...
											<form class="form-inline">
												<div class="form-group mx-sm-3 mb-2">
													<select class="custom-select" id="status-select"
														...
														<option value="sub"
															<c:out value="${cri.searchType eq 'sub'?'selected':''}"/>>항목명</option>
													</select>
												</div>
