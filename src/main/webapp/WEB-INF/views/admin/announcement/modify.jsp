							...
							<div class="page-title-right">
								<ol class="breadcrumb m-0">
									<li class="breadcrumb-item"><a
										href="AdminMainServlet?command=admin_main">PMIS</a></li>
									<li class="breadcrumb-item"><a
										href="AnnouncementServlet?command=admin_ann_list">취업공고 목록</a></li>
									<li class="breadcrumb-item"><a
										href="AnnouncementServlet?command=ann_read&annNo=${aVo.annNo}">취업공고
											상세내용</a></li>
									<li class="breadcrumb-item active">취업공고 수정</li>
								</ol>
							</div>
								...
								<form name="frm" method="post" >
									...
									<div class="form-group mb-3">
										<label for="inputEmail4" class="col-form-label">제목</label><span
											...
											id="title" class="form-control" value="${aVo.title}"
									...
									<div class="form-group mb-3">
										<label for="inputPassword4" class="col-form-label">회사명</label><span
											...
											value="${aVo.compName}" onKeyUp="fnChkByte(this,'50')">
									</div>
									...
									<div class="form-group mb-3">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="job" id="job"
												value="${aVo.job}" onKeyUp="fnChkByte(this,'30')">
										</div>
									</div>
									...
									<div class="form-group mb-3">
										<label for="inputCity" class="col-form-label">지역</label> <span
											...
											value="${aVo.compArea}" onKeyUp="fnChkByte(this,'50')">
									</div>


									<div class="form-group mb-3">
										<label for="inputPassword4" class="col-form-label">취업공고상세</label><span
											class="text-danger">*</span>
										<textarea class="form-control" name="content" id="content"
											rows="15" onKeyUp="fnChkByte(this,'4000')">${aVo.content}</textarea>
