							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">학생 e-포트폴리오 목록</li>
										<li class="breadcrumb-item active">학생 e-포트폴리오 상세보기</li>
									</ol>
								</div>
								<h4 class="page-title">학생 e-포트폴리오 상세보기</h4>
							</div>
						</div>
					</div>
				<!-- end page title -->
	...
	<script>
		$(document).ready(function() {
			...
			$(".btn-light").on("click", function() {
				...
				formObj.attr("action", "/admin/portfolio/list");
				formObj.submit();
			});
		});
