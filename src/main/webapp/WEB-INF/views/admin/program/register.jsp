				...
				<div class="container-fluid">
							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/admin/program/list">참여프로그램
										</a></li>
										<li class="breadcrumb-item active">참여프로그램 등록</li>
									</ol>
								</div>
								<h3 class="page-title">참여프로그램 등록</h3>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xl-12">
							...
							<div class="card">
								<div class="card-body">
									<h4 class=" header-title">참여프로그램 등록</h4>
