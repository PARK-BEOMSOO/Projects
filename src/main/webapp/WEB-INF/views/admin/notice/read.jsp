							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/admin/notice/list">공지사항</a></li>
														...
														<div
															...
															<div class="p-2">
																<div class="row align-items-center">
																	...
																	<div class="col pl-0">
																		<a href="/displayFile?fileName=${noticeFileVO.fileLocation}"
	...
	<script>
		$(document).ready(function() {
			...
			$(".btn-light").on("click", function() {
				formObj.attr("method", "get");
				formObj.attr("action", "/admin/notice/list");
				formObj.submit();
			});
		      /* 삭제버튼 */
