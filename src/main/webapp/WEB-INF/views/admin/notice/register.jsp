				...
				<div class="container-fluid">
							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/admin/notice/list">공지사항
										</a></li>
					...
					<div class="row">
						<div class="col-xl-12">
							...
							<div class="card">
								<div class="card-body">
									<h4 class=" header-title">공지사항 등록</h4>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="inputEmail4" class="col-form-label">작성자</label> <input
													type="text" name="register" id="register" value="${login.userName}"
