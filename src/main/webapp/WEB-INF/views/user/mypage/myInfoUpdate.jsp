                        ...
                        <div class="page-title-right">
                           <ol class="breadcrumb m-0">
                              <li class="breadcrumb-item"><a
                                 href="/user/mypage/myInfo">MyPage</a></li>
                              <!-- <li class="breadcrumb-item"><a
                        ...
                        <div class="card-body">
                           <form action="myInfoUpdate" method="post" onsubmit="return validate();">
                              ...
                              <div class="form-group mb-3 mainPw">
                               ...
                               <div class ="form-group mb-3 assent">
                               <br>
                                 <label for="userAgree">개인정보 동의여부</label><span class="text-danger">*</span> &nbsp&nbsp                                
                                 <input type="radio" class="radio-value" id=".radio-value" name="userAgree" value=1>
                                    동의 &nbsp
                                 <input type ="radio" class="radio-value" id=".radio-value" name="userAgree" value=0>
                                  거부 
