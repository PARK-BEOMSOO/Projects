									...
									<p class="text-muted font-13">신청 후에 수정과 삭제는 불가합니다.</p>
										...
										<div class="form-row">
											<div class="form-group col-md-6" style="visibility:hidden">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="subName" id="subName" disabled="disabled">
												</div>
											</div>
											<div class="form-group col-md-6">
												<label for="inputPassword4" class="col-form-label">환산 점수</label>
												<input type="text" name="acScore" id="acScore" class="form-control" value="${applyVO.conversionScore}" disabled="disabled">
											</div>
										</div>
