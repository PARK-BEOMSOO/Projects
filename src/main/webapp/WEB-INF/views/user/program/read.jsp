							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/user/program/list">참여프로그램 목록</a></li>
										<li class="breadcrumb-item active">참여프로그램 상세보기</li>
									</ol>
								</div>
								<h4 class="page-title">참여프로그램 상세보기</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
					...
					<form role="form" action="modify" method="post">
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="card">
									<div class="card-body">
										<h4 class="header-title">참여프로그램 상세보기</h4>
