							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">참여 프로그램 목록</li>
									</ol>
								</div>
								<h4 class="page-title">참여 프로그램 목록</h4>
							</div>
						</div>
					</div>
					<div class="row">
											...
											<tbody>
												<c:if test="${!empty list}">
													<c:forEach items="${list}" var="programVO"
														varStatus="status">
														<c:if test="${programVO.underline == 1}">
                                       					<tr style='background-color: rgba(248, 249, 252); font-weight:bold;'>
                                       					</c:if>
                                       					<c:if test="${programVO.underline == 0}">
                                       					<tr>
                                       					</c:if>
