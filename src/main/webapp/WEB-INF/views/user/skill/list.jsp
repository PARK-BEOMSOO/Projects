							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">보유기술 관리</li>
									</ol>
								</div>
								<h4 class="page-title">보유기술 관리</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${list}" var="list" varStatus="listStat">
	                                                    <tr>
	                                                    	...
	                                                    	<td>
															<a class="action-icon" onclick="return confirm('이 항목을 삭제하시겠습니까?');" href="remove?skillNo=${list.skillNo}&userNo=${login.userNo}">
