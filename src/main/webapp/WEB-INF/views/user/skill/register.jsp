							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/user/skill/list">보유기술 목록</a></li>
										<li class="breadcrumb-item active">보유기술 등록</li>
									</ol>
								</div>
								<h4 class="page-title">보유기술 등록</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
					...
					<div class="row">
                            <div class="col-12">
                                <div class="card">
									...
									<input type="hidden" name="skillNo" id="skillNo">
									<input type="hidden" name="userNo" id="userNo" value="${login.userNo}">

											<div class="form-group mb-3">
												<label for="inputEmail4" class="col-form-label">기술명</label><span class="text-danger">*</span>
												<div class="input-group">
													<input type="text" class="form-control" name="skillName" id="skillName" readonly="readonly" placeholder="항목명을 검색해주세요.">
