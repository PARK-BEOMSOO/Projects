...
public class GraduationTestVO {
	...
	private int testNo;// 졸업심사번호
	private String testState;// 승인 여부
	private Date applyDate;// 신청일
	private String reason;// 사유
	private int userNo;// 학번(FK)
	private int graduNo;// 졸업번호(FK)
	...
	public String toString() {
		return "GraduationTestVO [testNo=" + testNo + ", testState=" + testState + ", applyDate=" + applyDate
				+ ", reason=" + reason + ", userNo=" + userNo + ", graduNo=" + graduNo + ", appStart=" + appStart
				+ ", appEnd=" + appEnd + ", title=" + title + ", graduState=" + graduState + ", files="
				+ Arrays.toString(files) + ", userName=" + userName + ", grade=" + grade + ", underline=" + underline
				+ ", fileList=" + fileList + "]";
	}
