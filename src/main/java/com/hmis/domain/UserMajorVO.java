...
public class UserMajorVO {
	...
	public String toString() {
		return "UserMajorVO [userMajorNo=" + userMajorNo + ", userNo=" + userNo + ", majorNo=" + majorNo
				+ ", majorName=" + majorName + ", courseNo=" + courseNo + ", profName=" + profName + ", grade=" + grade
				+ ", trackCode=" + trackCode + ", profNo=" + profNo + "]";
	}
